...
<main>
  ...
  <div class="container-fluid">
    ...
    <?php foreach ($students as $students) : ?>
        ...
        <td><a href="crud/update.php?id=<?php echo $students['id']?>"><i class="bi bi-pencil fs-5 text-info"></i></a> <a href="student.php?id=<?php echo $students['id']?>" class="m-3"><i class="bi bi-trash fs-5 text-info"></i></a></td>
</tr>
<?php endforeach ?>
