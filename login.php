                  ...
                  <form action="usercontrole.php" method="POST">
                      <div class="p-4">
                          <div class="mb-3">
                              ...
                              <input type="email" class="form-control" placeholder="Enter your email" id="email" name="email"  value= <?php echo $_COOKIE['user']?> required/>
                          </div>
                          <div class="mb-3">
                              <label for="password" class="form-label">Password</label>
                              <input type="password" class="form-control" placeholder="Enter your password" id="password" name="password" value=<?php echo $_COOKIE['user_p']?>required/>
                          </div>
                          <div>
                          <div>
